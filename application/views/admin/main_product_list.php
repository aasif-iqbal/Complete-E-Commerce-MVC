...
<span>3. After adding variation - color, Add its different color options.</span>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a href="<?= base_url('edit-main-image/').$row->product_uuid; ?>" class="btn btn-info" role="button" aria-pressed="true">Edit Main Images</a>

      <a href="<?= base_url('edit-main-product-details/').$row->product_uuid; ?>" class="btn btn-primary" role="button" aria-pressed="true">Edit Product Details</a>
      
      <a href="<?= base_url('delete-main-product/').$row->product_uuid; ?>" class="btn btn-danger" role="button" aria-pressed="true">Delete</a>
      </td>
    </tr>
    <?php endforeach;}else{ ?>
      <tr>
